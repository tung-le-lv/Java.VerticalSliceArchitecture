...
/**
 * Not a mediator-dispatched validator (there is no Request&lt;T&gt; of type CreateOrderItemDto) —
 * invoked directly by CreateOrderValidator for each item, mirroring FluentValidation's
 * RuleForEach(...).SetValidator(new CreateOrderItemDtoValidator()) composition.
 */
