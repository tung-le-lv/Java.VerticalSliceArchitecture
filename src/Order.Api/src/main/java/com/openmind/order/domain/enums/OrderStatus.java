...
/**
 * Constant names are kept in the original PascalCase (not Java's UPPER_SNAKE_CASE) on purpose:
 * the DynamoDB Local seed data hardcoded in docker-compose.yaml stores these exact strings, and
 * changing casing here would break reads of that pre-seeded data.
 */
